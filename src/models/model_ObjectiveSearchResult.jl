...
"""
Base.@kwdef mutable struct ObjectiveSearchResult <: OpenAPI.APIModel
    ...
    function ObjectiveSearchResult(app_url, description, archived, started, entity_type, completed_at_override, started_at, completed_at, name, global_id, completed, state, started_at_override, updated_at, categories, id, key_result_ids, position, stats, created_at, )
        OpenAPI.validate_property(ObjectiveSearchResult, Symbol("app_url"), app_url)
        OpenAPI.validate_property(ObjectiveSearchResult, Symbol("description"), description)
        OpenAPI.validate_property(ObjectiveSearchResult, Symbol("archived"), archived)
        OpenAPI.validate_property(ObjectiveSearchResult, Symbol("started"), started)
        OpenAPI.validate_property(ObjectiveSearchResult, Symbol("entity_type"), entity_type)
        OpenAPI.validate_property(ObjectiveSearchResult, Symbol("completed_at_override"), completed_at_override)
        OpenAPI.validate_property(ObjectiveSearchResult, Symbol("started_at"), started_at)
        OpenAPI.validate_property(ObjectiveSearchResult, Symbol("completed_at"), completed_at)
        OpenAPI.validate_property(ObjectiveSearchResult, Symbol("name"), name)
        OpenAPI.validate_property(ObjectiveSearchResult, Symbol("global_id"), global_id)
        OpenAPI.validate_property(ObjectiveSearchResult, Symbol("completed"), completed)
        OpenAPI.validate_property(ObjectiveSearchResult, Symbol("state"), state)
        OpenAPI.validate_property(ObjectiveSearchResult, Symbol("started_at_override"), started_at_override)
        OpenAPI.validate_property(ObjectiveSearchResult, Symbol("updated_at"), updated_at)
        OpenAPI.validate_property(ObjectiveSearchResult, Symbol("categories"), categories)
        OpenAPI.validate_property(ObjectiveSearchResult, Symbol("id"), id)
        OpenAPI.validate_property(ObjectiveSearchResult, Symbol("key_result_ids"), key_result_ids)
        OpenAPI.validate_property(ObjectiveSearchResult, Symbol("position"), position)
        OpenAPI.validate_property(ObjectiveSearchResult, Symbol("stats"), stats)
        OpenAPI.validate_property(ObjectiveSearchResult, Symbol("created_at"), created_at)
...
function OpenAPI.validate_property(::Type{ ObjectiveSearchResult }, name::Symbol, val)
    ...
    if name === Symbol("completed_at_override")
        OpenAPI.validate_param(name, "ObjectiveSearchResult", :format, val, "date-time")
    end
    ...
    if name === Symbol("id")
        OpenAPI.validate_param(name, "ObjectiveSearchResult", :format, val, "int64")
    end
