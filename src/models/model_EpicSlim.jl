...
"""
Base.@kwdef mutable struct EpicSlim <: OpenAPI.APIModel
    ...
    function EpicSlim(app_url, description, archived, started, entity_type, labels, mention_ids, member_mention_ids, associated_groups, project_ids, stories_without_projects, completed_at_override, productboard_plugin_id, started_at, completed_at, objective_ids, name, global_id, completed, productboard_url, planned_start_date, state, milestone_id, requested_by_id, epic_state_id, label_ids, started_at_override, group_id, updated_at, group_mention_ids, productboard_id, follower_ids, group_ids, owner_ids, external_id, id, position, productboard_name, deadline, stats, created_at, )
        OpenAPI.validate_property(EpicSlim, Symbol("app_url"), app_url)
        OpenAPI.validate_property(EpicSlim, Symbol("description"), description)
        OpenAPI.validate_property(EpicSlim, Symbol("archived"), archived)
        OpenAPI.validate_property(EpicSlim, Symbol("started"), started)
        OpenAPI.validate_property(EpicSlim, Symbol("entity_type"), entity_type)
        OpenAPI.validate_property(EpicSlim, Symbol("labels"), labels)
        OpenAPI.validate_property(EpicSlim, Symbol("mention_ids"), mention_ids)
        OpenAPI.validate_property(EpicSlim, Symbol("member_mention_ids"), member_mention_ids)
        OpenAPI.validate_property(EpicSlim, Symbol("associated_groups"), associated_groups)
        OpenAPI.validate_property(EpicSlim, Symbol("project_ids"), project_ids)
        OpenAPI.validate_property(EpicSlim, Symbol("stories_without_projects"), stories_without_projects)
        OpenAPI.validate_property(EpicSlim, Symbol("completed_at_override"), completed_at_override)
        OpenAPI.validate_property(EpicSlim, Symbol("productboard_plugin_id"), productboard_plugin_id)
        OpenAPI.validate_property(EpicSlim, Symbol("started_at"), started_at)
        OpenAPI.validate_property(EpicSlim, Symbol("completed_at"), completed_at)
        OpenAPI.validate_property(EpicSlim, Symbol("objective_ids"), objective_ids)
        OpenAPI.validate_property(EpicSlim, Symbol("name"), name)
        OpenAPI.validate_property(EpicSlim, Symbol("global_id"), global_id)
        OpenAPI.validate_property(EpicSlim, Symbol("completed"), completed)
        OpenAPI.validate_property(EpicSlim, Symbol("productboard_url"), productboard_url)
        OpenAPI.validate_property(EpicSlim, Symbol("planned_start_date"), planned_start_date)
        OpenAPI.validate_property(EpicSlim, Symbol("state"), state)
        OpenAPI.validate_property(EpicSlim, Symbol("milestone_id"), milestone_id)
        OpenAPI.validate_property(EpicSlim, Symbol("requested_by_id"), requested_by_id)
        OpenAPI.validate_property(EpicSlim, Symbol("epic_state_id"), epic_state_id)
        OpenAPI.validate_property(EpicSlim, Symbol("label_ids"), label_ids)
        OpenAPI.validate_property(EpicSlim, Symbol("started_at_override"), started_at_override)
        OpenAPI.validate_property(EpicSlim, Symbol("group_id"), group_id)
        OpenAPI.validate_property(EpicSlim, Symbol("updated_at"), updated_at)
        OpenAPI.validate_property(EpicSlim, Symbol("group_mention_ids"), group_mention_ids)
        OpenAPI.validate_property(EpicSlim, Symbol("productboard_id"), productboard_id)
        OpenAPI.validate_property(EpicSlim, Symbol("follower_ids"), follower_ids)
        OpenAPI.validate_property(EpicSlim, Symbol("group_ids"), group_ids)
        OpenAPI.validate_property(EpicSlim, Symbol("owner_ids"), owner_ids)
        OpenAPI.validate_property(EpicSlim, Symbol("external_id"), external_id)
        OpenAPI.validate_property(EpicSlim, Symbol("id"), id)
        OpenAPI.validate_property(EpicSlim, Symbol("position"), position)
        OpenAPI.validate_property(EpicSlim, Symbol("productboard_name"), productboard_name)
        OpenAPI.validate_property(EpicSlim, Symbol("deadline"), deadline)
        OpenAPI.validate_property(EpicSlim, Symbol("stats"), stats)
        OpenAPI.validate_property(EpicSlim, Symbol("created_at"), created_at)
        return new(app_url, description, archived, started, entity_type, labels, mention_ids, member_mention_ids, associated_groups, project_ids, stories_without_projects, completed_at_override, productboard_plugin_id, started_at, completed_at, objective_ids, name, global_id, completed, productboard_url, planned_start_date, state, milestone_id, requested_by_id, epic_state_id, label_ids, started_at_override, group_id, updated_at, group_mention_ids, productboard_id, follower_ids, group_ids, owner_ids, external_id, id, position, productboard_name, deadline, stats, created_at, )
    end
end # type EpicSlim

const _property_types_EpicSlim = Dict{Symbol,String}(Symbol("app_url")=>"String", Symbol("description")=>"String", Symbol("archived")=>"Bool", Symbol("started")=>"Bool", Symbol("entity_type")=>"String", Symbol("labels")=>"Vector{LabelSlim}", Symbol("mention_ids")=>"Vector{String}", Symbol("member_mention_ids")=>"Vector{String}", Symbol("associated_groups")=>"Vector{EpicAssociatedGroup}", Symbol("project_ids")=>"Vector{Int64}", Symbol("stories_without_projects")=>"Int64", Symbol("completed_at_override")=>"ZonedDateTime", Symbol("productboard_plugin_id")=>"String", Symbol("started_at")=>"ZonedDateTime", Symbol("completed_at")=>"ZonedDateTime", Symbol("objective_ids")=>"Vector{Int64}", Symbol("name")=>"String", Symbol("global_id")=>"String", Symbol("completed")=>"Bool", Symbol("productboard_url")=>"String", Symbol("planned_start_date")=>"ZonedDateTime", Symbol("state")=>"String", Symbol("milestone_id")=>"Int64", Symbol("requested_by_id")=>"String", Symbol("epic_state_id")=>"Int64", Symbol("label_ids")=>"Vector{Int64}", Symbol("started_at_override")=>"ZonedDateTime", Symbol("group_id")=>"String", Symbol("updated_at")=>"ZonedDateTime", Symbol("group_mention_ids")=>"Vector{String}", Symbol("productboard_id")=>"String", Symbol("follower_ids")=>"Vector{String}", Symbol("group_ids")=>"Vector{String}", Symbol("owner_ids")=>"Vector{String}", Symbol("external_id")=>"String", Symbol("id")=>"Int64", Symbol("position")=>"Int64", Symbol("productboard_name")=>"String", Symbol("deadline")=>"ZonedDateTime", Symbol("stats")=>"EpicStats", Symbol("created_at")=>"ZonedDateTime", )
OpenAPI.property_type(::Type{ EpicSlim }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_EpicSlim[name]))}

function check_required(o::EpicSlim)
...
function OpenAPI.validate_property(::Type{ EpicSlim }, name::Symbol, val)
    ...
    if name === Symbol("stories_without_projects")
        OpenAPI.validate_param(name, "EpicSlim", :format, val, "int64")
    end

    if name === Symbol("completed_at_override")
        OpenAPI.validate_param(name, "EpicSlim", :format, val, "date-time")
    end

    if name === Symbol("productboard_plugin_id")
        OpenAPI.validate_param(name, "EpicSlim", :format, val, "uuid")
    end
