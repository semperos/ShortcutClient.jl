...
"""
Base.@kwdef mutable struct Epic <: OpenAPI.APIModel
    ...
    function Epic(app_url, description, archived, started, entity_type, labels, mention_ids, member_mention_ids, associated_groups, project_ids, stories_without_projects, completed_at_override, productboard_plugin_id, started_at, completed_at, objective_ids, name, global_id, completed, comments, productboard_url, planned_start_date, state, milestone_id, requested_by_id, epic_state_id, label_ids, started_at_override, group_id, updated_at, group_mention_ids, productboard_id, follower_ids, group_ids, owner_ids, external_id, id, position, productboard_name, deadline, stats, created_at, )
        OpenAPI.validate_property(Epic, Symbol("app_url"), app_url)
        OpenAPI.validate_property(Epic, Symbol("description"), description)
        OpenAPI.validate_property(Epic, Symbol("archived"), archived)
        OpenAPI.validate_property(Epic, Symbol("started"), started)
        OpenAPI.validate_property(Epic, Symbol("entity_type"), entity_type)
        OpenAPI.validate_property(Epic, Symbol("labels"), labels)
        OpenAPI.validate_property(Epic, Symbol("mention_ids"), mention_ids)
        OpenAPI.validate_property(Epic, Symbol("member_mention_ids"), member_mention_ids)
        OpenAPI.validate_property(Epic, Symbol("associated_groups"), associated_groups)
        OpenAPI.validate_property(Epic, Symbol("project_ids"), project_ids)
        OpenAPI.validate_property(Epic, Symbol("stories_without_projects"), stories_without_projects)
        OpenAPI.validate_property(Epic, Symbol("completed_at_override"), completed_at_override)
        OpenAPI.validate_property(Epic, Symbol("productboard_plugin_id"), productboard_plugin_id)
        OpenAPI.validate_property(Epic, Symbol("started_at"), started_at)
        OpenAPI.validate_property(Epic, Symbol("completed_at"), completed_at)
        OpenAPI.validate_property(Epic, Symbol("objective_ids"), objective_ids)
        OpenAPI.validate_property(Epic, Symbol("name"), name)
        OpenAPI.validate_property(Epic, Symbol("global_id"), global_id)
        OpenAPI.validate_property(Epic, Symbol("completed"), completed)
        OpenAPI.validate_property(Epic, Symbol("comments"), comments)
        OpenAPI.validate_property(Epic, Symbol("productboard_url"), productboard_url)
        OpenAPI.validate_property(Epic, Symbol("planned_start_date"), planned_start_date)
        OpenAPI.validate_property(Epic, Symbol("state"), state)
        OpenAPI.validate_property(Epic, Symbol("milestone_id"), milestone_id)
        OpenAPI.validate_property(Epic, Symbol("requested_by_id"), requested_by_id)
        OpenAPI.validate_property(Epic, Symbol("epic_state_id"), epic_state_id)
        OpenAPI.validate_property(Epic, Symbol("label_ids"), label_ids)
        OpenAPI.validate_property(Epic, Symbol("started_at_override"), started_at_override)
        OpenAPI.validate_property(Epic, Symbol("group_id"), group_id)
        OpenAPI.validate_property(Epic, Symbol("updated_at"), updated_at)
        OpenAPI.validate_property(Epic, Symbol("group_mention_ids"), group_mention_ids)
        OpenAPI.validate_property(Epic, Symbol("productboard_id"), productboard_id)
        OpenAPI.validate_property(Epic, Symbol("follower_ids"), follower_ids)
        OpenAPI.validate_property(Epic, Symbol("group_ids"), group_ids)
        OpenAPI.validate_property(Epic, Symbol("owner_ids"), owner_ids)
        OpenAPI.validate_property(Epic, Symbol("external_id"), external_id)
        OpenAPI.validate_property(Epic, Symbol("id"), id)
        OpenAPI.validate_property(Epic, Symbol("position"), position)
        OpenAPI.validate_property(Epic, Symbol("productboard_name"), productboard_name)
        OpenAPI.validate_property(Epic, Symbol("deadline"), deadline)
        OpenAPI.validate_property(Epic, Symbol("stats"), stats)
        OpenAPI.validate_property(Epic, Symbol("created_at"), created_at)
        return new(app_url, description, archived, started, entity_type, labels, mention_ids, member_mention_ids, associated_groups, project_ids, stories_without_projects, completed_at_override, productboard_plugin_id, started_at, completed_at, objective_ids, name, global_id, completed, comments, productboard_url, planned_start_date, state, milestone_id, requested_by_id, epic_state_id, label_ids, started_at_override, group_id, updated_at, group_mention_ids, productboard_id, follower_ids, group_ids, owner_ids, external_id, id, position, productboard_name, deadline, stats, created_at, )
    end
end # type Epic

const _property_types_Epic = Dict{Symbol,String}(Symbol("app_url")=>"String", Symbol("description")=>"String", Symbol("archived")=>"Bool", Symbol("started")=>"Bool", Symbol("entity_type")=>"String", Symbol("labels")=>"Vector{LabelSlim}", Symbol("mention_ids")=>"Vector{String}", Symbol("member_mention_ids")=>"Vector{String}", Symbol("associated_groups")=>"Vector{EpicAssociatedGroup}", Symbol("project_ids")=>"Vector{Int64}", Symbol("stories_without_projects")=>"Int64", Symbol("completed_at_override")=>"ZonedDateTime", Symbol("productboard_plugin_id")=>"String", Symbol("started_at")=>"ZonedDateTime", Symbol("completed_at")=>"ZonedDateTime", Symbol("objective_ids")=>"Vector{Int64}", Symbol("name")=>"String", Symbol("global_id")=>"String", Symbol("completed")=>"Bool", Symbol("comments")=>"Vector{ThreadedComment}", Symbol("productboard_url")=>"String", Symbol("planned_start_date")=>"ZonedDateTime", Symbol("state")=>"String", Symbol("milestone_id")=>"Int64", Symbol("requested_by_id")=>"String", Symbol("epic_state_id")=>"Int64", Symbol("label_ids")=>"Vector{Int64}", Symbol("started_at_override")=>"ZonedDateTime", Symbol("group_id")=>"String", Symbol("updated_at")=>"ZonedDateTime", Symbol("group_mention_ids")=>"Vector{String}", Symbol("productboard_id")=>"String", Symbol("follower_ids")=>"Vector{String}", Symbol("group_ids")=>"Vector{String}", Symbol("owner_ids")=>"Vector{String}", Symbol("external_id")=>"String", Symbol("id")=>"Int64", Symbol("position")=>"Int64", Symbol("productboard_name")=>"String", Symbol("deadline")=>"ZonedDateTime", Symbol("stats")=>"EpicStats", Symbol("created_at")=>"ZonedDateTime", )
OpenAPI.property_type(::Type{ Epic }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_Epic[name]))}

function check_required(o::Epic)
...
function OpenAPI.validate_property(::Type{ Epic }, name::Symbol, val)
    ...
    if name === Symbol("stories_without_projects")
        OpenAPI.validate_param(name, "Epic", :format, val, "int64")
    end

    if name === Symbol("completed_at_override")
        OpenAPI.validate_param(name, "Epic", :format, val, "date-time")
    end

    if name === Symbol("productboard_plugin_id")
        OpenAPI.validate_param(name, "Epic", :format, val, "uuid")
    end
