...
"""
Base.@kwdef mutable struct CreateStoryContents <: OpenAPI.APIModel
    ...
    function CreateStoryContents(description, labels, story_type, custom_fields, file_ids, name, epic_id, external_links, iteration_id, tasks, group_id, workflow_state_id, follower_ids, owner_ids, estimate, project_id, linked_file_ids, deadline, )
        OpenAPI.validate_property(CreateStoryContents, Symbol("description"), description)
        OpenAPI.validate_property(CreateStoryContents, Symbol("labels"), labels)
        OpenAPI.validate_property(CreateStoryContents, Symbol("story_type"), story_type)
        OpenAPI.validate_property(CreateStoryContents, Symbol("custom_fields"), custom_fields)
        OpenAPI.validate_property(CreateStoryContents, Symbol("file_ids"), file_ids)
        OpenAPI.validate_property(CreateStoryContents, Symbol("name"), name)
        OpenAPI.validate_property(CreateStoryContents, Symbol("epic_id"), epic_id)
        OpenAPI.validate_property(CreateStoryContents, Symbol("external_links"), external_links)
        OpenAPI.validate_property(CreateStoryContents, Symbol("iteration_id"), iteration_id)
        OpenAPI.validate_property(CreateStoryContents, Symbol("tasks"), tasks)
        OpenAPI.validate_property(CreateStoryContents, Symbol("group_id"), group_id)
        OpenAPI.validate_property(CreateStoryContents, Symbol("workflow_state_id"), workflow_state_id)
        OpenAPI.validate_property(CreateStoryContents, Symbol("follower_ids"), follower_ids)
        OpenAPI.validate_property(CreateStoryContents, Symbol("owner_ids"), owner_ids)
        OpenAPI.validate_property(CreateStoryContents, Symbol("estimate"), estimate)
        OpenAPI.validate_property(CreateStoryContents, Symbol("project_id"), project_id)
        OpenAPI.validate_property(CreateStoryContents, Symbol("linked_file_ids"), linked_file_ids)
        OpenAPI.validate_property(CreateStoryContents, Symbol("deadline"), deadline)
...
function OpenAPI.validate_property(::Type{ CreateStoryContents }, name::Symbol, val)
    ...
    if name === Symbol("file_ids")
        OpenAPI.validate_param(name, "CreateStoryContents", :uniqueItems, val, true)
    end

    if name === Symbol("name")
        OpenAPI.validate_param(name, "CreateStoryContents", :maxLength, val, 512)
    end

    if name === Symbol("epic_id")
        OpenAPI.validate_param(name, "CreateStoryContents", :format, val, "int64")
    end
    ...
    if name === Symbol("group_id")
        OpenAPI.validate_param(name, "CreateStoryContents", :format, val, "uuid")
    end
    ...
    if name === Symbol("deadline")
        OpenAPI.validate_param(name, "CreateStoryContents", :format, val, "date-time")
    end
end
